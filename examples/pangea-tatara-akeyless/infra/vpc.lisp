...
(defteia
  ...
  :atributos (
    ...
    :tags (:name "pangea-tatara-akeyless" :owner "pleme-io" :managed-by "caixa")))
...
(defteia
  ...
  :atributos (
    :vpc-id (ref
      ...
      main
      id)
    :tags (:name "pangea-tatara-akeyless-igw" :owner "pleme-io")))
...
(defteia
  ...
  :atributos (
    ...
    :tags (:name "public-1a" :tier "public" :owner "pleme-io")))

(defteia
  :tipo aws/route-table
  :nome public
  :atributos (:vpc-id (ref aws/vpc main id) :tags (:name "public" :owner "pleme-io")))
