...
(defcheck vpc-has-owner-tag (every-defteia :tipo aws/vpc (has-kwarg :tags (has-kwarg :owner))))

(defcheck
  every-akeyless-target-has-region
  (every-defteia :tipo akeyless/target-aws (has-kwarg :region)))
