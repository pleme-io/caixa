...
pub use render::{
    ...
    M2_KEY_UPGRADE_FROM, M3_KEY_PLACEMENT, PLEME_LABEL_PREFIX, RenderError, WIT_IDENT_MAX_LEN,
    is_dns_1123_label, is_gateway_api_http_path, is_wit_world_ref, kube_resource_skeleton,
